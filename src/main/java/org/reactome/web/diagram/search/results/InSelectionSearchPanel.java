 ...
 */
public class InSelectionSearchPanel extends Composite implements ResultsWidget {

    private Label lb;

    public InSelectionSearchPanel() {
        lb = new Label();
                /*
    ...
    public void updateResults(SearchArguments args) {
        lb.setText("In Selection search: " + args.getTerm());
    }
}
