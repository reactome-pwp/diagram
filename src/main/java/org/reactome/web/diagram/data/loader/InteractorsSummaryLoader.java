 ...
 */
public class InteractorsSummaryLoader extends InteractorsLoader {

    InteractorsSummaryLoader(Handler handler) {
        super(handler);
    }
    ...
    public void load(String stId, String resource){
        ...
        String url = PREFIX + resource + "/" + stId + ".summary.json?v=" + LoaderManager.version;
