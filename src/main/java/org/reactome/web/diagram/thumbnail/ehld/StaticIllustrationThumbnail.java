...
public class StaticIllustrationThumbnail extends AbstractSVGPanel implements Thumbnail, ContextMenuHandler,
    ...
    public StaticIllustrationThumbnail(EventBus eventBus) {
        ...
        this.getElement().addClassName("pwp-StaticThumbnail");
        this.getElement().getStyle().setLeft(150, Style.Unit.PX);
